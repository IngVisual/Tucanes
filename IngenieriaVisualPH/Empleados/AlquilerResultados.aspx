<%@ Page Title="" Language="C#" MasterPageFile="~/Empleados/Empleados.Master" AutoEventWireup="true" CodeBehind="AlquilerResultados.aspx.cs" Inherits="IngenieriaVisualPH.Empleados.Formulario_web117" %>
...
<script>
  ...
  <form id="form1" runat="server">
    ...
    <div class="container" id="conta">
        <h5 class="text-center">Resultados Alquiler</h5>
            <div class="card-body"> 
                <div class="col-md-12">
