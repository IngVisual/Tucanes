<%@ Page Title="" Language="C#" MasterPageFile="~/Empleados/Empleados.Master" AutoEventWireup="true" CodeBehind="VigSalidasEditar.aspx.cs" Inherits="IngenieriaVisualPH.Empleados.Formulario_web110" %>
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
    ...
    <form id="form" runat="server">
        <div id="programacion" runat="server">
            <h3 class="font-weight-bold text-capitalize text-light text-center">EDITAR PROGRAMACIÓN MUDANZAS</h3>
            <p></p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card" style="border-radius: 5px">
                    <div class="card-body">
                        ...
                        <p></p>
                        Describa aqui, si hubo alguna novedad en la Mudanza
                        <asp:TextBox ID="txtobservacion" runat="server" Font-Size="Small" Text="" MaxLength="300" Placeholder="Novedad de Mudanza" CssClass="form-control" Enabled="True" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </div>
            </div>
