<%@ Page Title="" Language="C#" MasterPageFile="~/Empleados/Aseo.Master" AutoEventWireup="true" CodeBehind="VigSCAseo.aspx.cs" Inherits="IngenieriaVisualPH.Empleados.Formulario_web113" %>
                                ...
                                <div class="stat-widget-one">
                                    ...
                                    <div class="row">
                                        ...
                                        &nbsp;&nbsp<div class="text-light">
                                            <asp:Label ID="label3" runat="server" BackColor="#3366cc" Font-Size="Smaller" CssClass="text-light font-weight-bold form-control"><%#Eval("SalCom") %></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
