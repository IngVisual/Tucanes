<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="NotificaPush.aspx.cs" Inherits="IngenieriaVisualPH.Administracion.Formulario_web137" %>
            ...
            <div class="col-xs-6 col-lg-8">
                <div class="card border border-success" style="border-radius: 7px">
                    <div class="card-header">
                        <strong>Notificaciones Push Masivas</strong>
                    </div>
                    <div class="card-body">
                        <div class="col-xs-6 col-lg-12">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txttitulo" CssClass="form-control font-weight-bold" Font-Size="Small" MaxLength="30" runat="server"></asp:TextBox>
                        ...
                        <div class="col-xs-6 col-lg-12">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtmsg" CssClass="form-control" Font-Size="Small" runat="server" MaxLength="100" TextMode="MultiLine"></asp:TextBox>
