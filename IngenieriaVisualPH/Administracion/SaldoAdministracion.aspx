<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="SaldoAdministracion.aspx.cs" Inherits="IngenieriaVisualPH.Administracion.Formulario_web120" %>
      ...
      <input type="checkbox" onclick="ShowVideo()" id="btn-modale" />
        ...
        <div class="modale">
            <div class="contenedor" id="mostrarvideo">
                ...
                <a href="SaldoAdministracion.aspx">&#10006;</a>
                <div class="contenido">
                     <iframe width="1000" height="550" src="https://www.youtube.com/embed/ULTyF4IV4OQ" frameborder="0" allow="accelerometer; 
