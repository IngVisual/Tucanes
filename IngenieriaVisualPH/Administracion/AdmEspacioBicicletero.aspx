<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="AdmEspacioBicicletero.aspx.cs" Inherits="IngenieriaVisualPH.Administracion.Formulario_web154" %>
         ...
         <div id="procesando" class="ventana" style="border-radius: 7px; display: none">
            ...
            <br />
             ...
             <div class="alert alert-success" style="margin-top: 10px;">
                ...
                Esta tabla solo muestra los espacios de biciletero autorizados por Apartamento. En la edicion solo te permite cambiar el estado cuando retires el espacio a un cicla o cuando modifiques el numero de bicicletero a una cicla autorizada. Esta informacion la ve en linea el GUARDA y el RESIDENTE.
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Tablero de Bicicletreo</strong>
                                </div>
                                <div class="card-body">
                                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                        <asp:Repeater ID="r1" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                     <td><a href="EditarBicicletero.aspx?Id=<%#Eval("Id")%>">
