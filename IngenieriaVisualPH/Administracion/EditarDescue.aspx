<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="EditarDescue.aspx.cs" Inherits="IngenieriaVisualPH.Administracion.Formulario_web130" %>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-lg-2">
                                    <div>
                                        <asp:Button ID="btndescuen" runat="server" OnClick="btndescuen_Click" Text="Agregar" CssClass=" btn-primary font-weight-bold form-control border-light" />
                                    </div>
                                </div>
                                </div>
                            </div>
