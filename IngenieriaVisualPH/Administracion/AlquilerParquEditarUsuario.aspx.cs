...
namespace IngenieriaVisualPH.Administracion
{
    public partial class Formulario_web151 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (activo == "True") { cmd.CommandText = "update ParqTbl_CMVigilante set Activo = 0 where Id=" + id + ""; }
            else { cmd.CommandText = "update ParqTbl_CMVigilante set Activo = 1 where Id=" + id + ""; }
            cmd.ExecuteNonQuery();
            con.Cerrar();
