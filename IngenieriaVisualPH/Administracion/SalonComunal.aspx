<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="SalonComunal.aspx.cs" Inherits="IngenieriaVisualPH.Administracion.Formulario_web111" %>
      ...
      <input type="checkbox" onclick="ShowVideo()" id="btn-modale" />
        ...
        <div class="modale">
            <div class="contenedor" id="mostrarvideo">
                ...
                <a href="SalonComunal.aspx">&#10006;</a>
                <div class="contenido">
                     <iframe width="1000" height="550" src="https://www.youtube.com/embed/fMLQizCxxaY" frameborder="0" allow="accelerometer; 
...
<%-- -------------------------------------------------------------------- --%>
    <div class="container" id="conta">
        <h3 class="text-center font-weight-bold text-light">Solicitudes de Salon Comunal</h3>
        <br />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-6">
                            ...
                            <strong>¿Desea registrar un alquiler de SALON COMUNAL como Administrador.. ?</strong>
                            &nbsp;&nbsp;
                        </div>
                        <div class="col-lg-2">
                            <asp:Button ID="btnir" OnClick="btnir_Click" style="border-radius:7px" Text="Reservar" runat="server" class=" btn btn-success font-weight-bold form-control border-dark animate__animated animate__pulse animate__infinite" />
                        </div>
            ...
            <section class="content col-xs-6 col-lg-12" id="displayEditar">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card" style="border-radius: 7px">
                            <div class="card-header">
                                <strong>Estados SOLICITUD DE SALON COMUNAL</strong>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="card col-lg-6 col-md-6 no-padding no-shado">
                                        <div class="card-body bg-flat-color-3">
                                            ...
                                            <small class="text-uppercase font-weight-bold text-light">NOVEDADES</small>
                                            <div class="progress progress-xs mt-3 mb-0 bg-light" style="width: 40%; height: 5px;"></div>
                                        </div>
                                    </div>
                                </div>
