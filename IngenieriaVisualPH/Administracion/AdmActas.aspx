<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="AdmActas.aspx.cs" Inherits="IngenieriaVisualPH.Administracion.Formulario_web122" %>
                                        ...
                                        <div class="card-body">
                                            <table class="table">
                                                <asp:Repeater ID="r1" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td><a href="EliminarActa.aspx?Id=<%#Eval("Id")%>">
