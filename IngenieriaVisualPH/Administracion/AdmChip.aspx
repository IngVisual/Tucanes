<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="AdmChip.aspx.cs" Inherits="IngenieriaVisualPH.Administracion.Formulario_web118" %>
      ...
      <input type="checkbox" onclick="ShowVideo()" id="btn-modale" />
        ...
        <div class="modale">
            <div class="contenedor" id="mostrarvideo">
                ...
                <a href="AdmChip.aspx">&#10006;</a>
                <div class="contenido">
                  <iframe width="1000" height="550" src="https://www.youtube.com/embed/5nThX7B_Wuk" frameborder="0" allow="accelerometer; 
...
<%-- -------------------------------------------------------------------- --%>
    <div class="container" id="conta">
        <h3 class="text-center font-weight-bold text-light">Solicitudes de Chips</h3>
        <br />
            ...
            <section class="content col-xs-6 col-lg-12" id="displayEditar">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card" style="border-radius: 7px">
                            <div class="card-header">
                                <strong>Estados SOLICITUD DE CHIPS</strong>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="card col-lg-6 col-md-6 no-padding no-shado">
                                        <div class="card-body bg-flat-color-3">
                                            ...
                                            <small class="text-uppercase font-weight-bold text-light">NO AUTORIZADOS</small>
                                            <div class="progress progress-xs mt-3 mb-0 bg-light" style="width: 40%; height: 5px;"></div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <asp:Repeater ID="r1" runat="server">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <small class="text-primary"><i class="fa fa-lock">&nbsp;<%#Eval("Tipo") %></i></small></td>
                                                          <td>
