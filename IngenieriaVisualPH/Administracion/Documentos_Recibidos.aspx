<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="Documentos_Recibidos.aspx.cs" Inherits="IngenieriaVisualPH.Administracion.Formulario_web17" %>
      ...
      <input type="checkbox" onclick="ShowVideo()" id="btn-modale" />
        ...
        <div class="modale">
            <div class="contenedor" id="mostrarvideo">
                ...
                <a href="Documentos_Recibidos.aspx">&#10006;</a>
                <div class="contenido">
                    <iframe width="1000" height="550" src="https://www.youtube.com/embed/P7yJhwO76f8" frameborder="0" allow="accelerometer; 
...
<%-- -------------------------------------------------------------------- --%>
    <div class="container" id="conta">
      <h3 class="text-center font-weight-bold text-light">Solicitudes de Parqueadero</h3>
         <br/>
             ...
             <section class="content col-xs-6 col-lg-12" id="displayEditar">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card" style="border-radius: 7px">
                            <div class="card-header">
                                <strong>Estados SOLICITUD DE PARQUEADERO</strong>
                            </div>
                ...
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card" style="border-radius: 7px">
                                <div class="card-header">
                                    <strong class="card-title">SOLICITUDES DE PARQUEADERO</strong>&nbsp;&nbsp;<a href="AdmParqueadero.aspx"
                                                        <button class="btn btn-success font-weight-bold" type="button" style="border-radius: 5px" title="Ver"><i class="fa fa-car">&nbsp;Ver Tabla de Parqueaderos</i></button></a>
                                </div>
                                <div class="card-body">
                                    <table class="table">
