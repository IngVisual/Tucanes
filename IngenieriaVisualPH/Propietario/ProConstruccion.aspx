<%@ Page Title="" Language="C#" MasterPageFile="~/Propietario/Propietario.Master" AutoEventWireup="true" CodeBehind="ProConstruccion.aspx.cs" Inherits="IngenieriaVisualPH.Propietario.Formulario_web165" %>
    ...
    <div class="container" id="conta">
        ...
        <form id="fo1" runat="server">
            ...
            <div id="pregunta1">
                ...
                <p></p>
                <p class="card-title textocolorinfo font-weight-bold"><i class="fa fa-hand-o-right">NOMBRES COMPLETOS Y #CC DE LAS PERSONAS QUE TRABAJARAN EL PREDIO</i></p>
                <p class="card-title textocolorinfo font-weight-bold"><i class="fa fa-hand-o-right">FOTO DE LA CEDULA DEL PROPIETARIO  <asp:Label ID="lblpro" runat="server" Font-Bold="true" CssClass="textocolorinfo" Text=""></asp:Label> en Formato Imagen png, jpg, jpeg, foto directa o captura de pantalla </i></p>
                 <p class="card-title textocolorinfo font-weight-bold"><i class="fa fa-hand-o-right">UN SOLO PDF con los siguientes documentos: </i></p>
                ...
                <div class="alert alert-danger" id="error1" runat="server" style="margin-top: 10px;">
                    ...
                    <p></p>
                    <p class="text-dark font-weight-bold">Pirmero: Cedulas de ciudadanía de las personas que trabajaran en la construcción y traslado del material</p>
                    <p class="text-dark font-weight-bold">Segundo: ARL de las personas que trabajaran en la construcción y traslado del material</p>
                    <p></p>
                </div>
                <div class="alert alert-primary" id="error" runat="server" style="margin-top: 10px;">
                    IMPORTANTE: Si no adjunta el PDF con los documentos completos, por norma del conjunto no se podra AUTORIZAR el ingreso del material.
                </div>
                <br />
                <p>
            ...
            <div id="form2" style="display: none">
                <div class="card bordercolorinfo">
                    ...
                    <div class="form-group" id="foto4" style="display: none">
                        <div class="card-body">
                            <label for="" class="control-label mb-1 textocolorinfo font-weight-bold">Nombres y # de cedulas de las personas que trabajaran en el predio</label>
                            <asp:TextBox ID="txtarticulos" runat="server" MaxLength="95" Text="" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                            <p></p>
                            <p>
