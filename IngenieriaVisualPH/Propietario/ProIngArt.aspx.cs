...
namespace IngenieriaVisualPH.Propietario
{
    public partial class Formulario_web134 : System.Web.UI.Page
    {
        ...
        Datos.MapeoUsuarios usuario = new Datos.MapeoUsuarios();
        ...
        public void PoliticaMudanza()
        {
            ...
            foreach (DataRow item in dt.Rows)
            {
                ...
                lblmsg2.Text = item["ContratoMudanza"].ToString();
            }
        }
        ...
        public void GuardarSolSalArt()
        {
            ...
            else
            {
                ...
                lblMessage.Text = "(cedula) Solo permite imagenes .png , .jpg , .jpeg. Si es un .pdf, haga una captura de pantalla del pdf y adjunte la captura de pantalla,Ingrese nuevamente y finalice el registro";
            }
        }
    }
}