...
namespace IngenieriaVisualPH.Propietario
{
    public partial class Formulario_web15 : System.Web.UI.Page
    {
        ...
        {           
            lblmensaje1.Text = "Como propietario del apartamento: <span>" + lblcodigo.Text + "</span> del conjunto residencial<span> " + lblconjunto.Text + "</span> declaro que me hago responsable por el comportamiento y convivencia de mis arrendatarios o propietarios y sus visitantes, comprometiéndome a colaborar para que cumplamos la normatividad; asumiendo la responsabilidad sobre llamados de atención y/ o sanciones que se impongan como consecuencia de los comportamientos contrarios a la convivencia.Y que me comprometo a hacer entrega de la llave de acceso a la puerta principal de la torre, así como los chips de ingreso al conjunto residencial.<br/> " +
                "<br/> De igual forma acepto como una causal de terminación de contrato de arrendamiento para restituir el inmueble por parte de los arrendatarios, la imposición de tres (3) llamados de atención convivencial y/o la imposición de sanción económica " +
                "<br/>  Conforme a la ley 1581 de 2012, autorizó al conjunto residencial, al tratamiento de los datos personales consignados en la presente aplicación.";
            lblasunto.Text = "POLITICA DE CONVIVENCIA CONJUNTO " + lblconjunto.Text + " ";
            try
            {
                lblconjunto.Text = Session["conj"].ToString();
        ...
        protected void btnactualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                usuario.Codigo = int.Parse(lblapa.Text);
                ...
                usuario.NombrePropietario = lblnombre.Text;
                ...
                if (fila == 1)
                {
                    ...
                    Response.Redirect("Perfil_Propietario.aspx");
                }
            }
