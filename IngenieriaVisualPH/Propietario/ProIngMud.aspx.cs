...
namespace IngenieriaVisualPH.Propietario
{
    public partial class Formulario_web135 : System.Web.UI.Page
    {
        ...
        string Msm = "Realizo una solicitud de Mudanza. (Ingreso de Mudanza Completa)";
        ...
        protected void btnenviardocuemnto_Click(object sender, EventArgs e)
        {
            if (txtarticulos.Text == "" || txtcedula.Text == "" || txtencargado.Text == "" || txtfechafin.Text == "" ||
               txtfechaini.Text == "" || FileUpload1.HasFile == false || FileUpload2.HasFile == false || ddesatdo.Text == "" )
            {
                lblMessage.Visible = false;
                lblMessage2.Visible = true;
                lblMessage3.Visible = false;
                lblMessage2.Text = "Debe llenar todos los datos requeridos.      Ingrese nuevamente y finalice la solicitud";
            }else if(ddesatdo.Text == "Arrendado" && txtcelarr.Text=="")
            {
                lblMessage.Visible = false;
                lblMessage2.Visible = false;
                lblMessage3.Visible= true;
                lblMessage3.Text = "Si arrendo el predio, debe ingresar el CELULAR del NUEVO INQUILINO para la CITOFONIA.      Ingrese nuevamente y finalice la solicitud";
            }
            else
            {
                ObtenerIdMax();
