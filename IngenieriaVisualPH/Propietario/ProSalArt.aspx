<%@ Page Title="" Language="C#" MasterPageFile="~/Propietario/Propietario.Master" AutoEventWireup="true" CodeBehind="ProSalArt.aspx.cs" Inherits="IngenieriaVisualPH.Propietario.Formulario_web130" %>
...
<link href="../Diseño/Color.css" rel="stylesheet" />
    ...
    <div class="container" id ="conta">
        <h3 class="text-center textocolorinfo font-weight-bold">Salida de Algunos Articulos Individuales</h3>
        <td colspan="2">
            ...
            <div id="form2" style="display: none">
                <div class="card bordercolorinfo">
                    ...
                    <div class="form-group" id="foto3" style="display: none">
                        <div class="card-body">
                            <label for="" class="control-label mb-1 textocolorinfo font-weight-bold">Articulos a Retirar</label>
                            <asp:TextBox ID="txtarticulos" runat="server" MaxLength="40" CssClass="form-control"></asp:TextBox>
                    ...
                    <div class="form-group" id="foto4" style="display: none">
                        <div class="card-body">
                            ...
                            <p></p>
                            <label for="" class="control-label mb-1 textocolorinfo font-weight-bold">Fecha de salida HASTA:</label>
                    ...
                    <div class="form-group" id="foto6" style="display: none">
                        <div>
                            ...
                            <div class="clear-btn">
                                <button id="clear-signature" type="button" data-tool="eraser" class="btn-block btn-secondary btn-lg bordercolorinfo font-weight-bold"><span>Borrar </span></button>
                            </div>
                            <div class="card">
