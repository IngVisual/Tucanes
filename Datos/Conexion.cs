...
namespace Datos
{
    public class Conexion
    {
        ...
        public void Abrir()
        {
            ...
            conexion = new SqlConnection("workstation id=DBconjuntoid012.mssql.somee.com;packet size=4096;user id=AppCibeles_SQLLogin_1;pwd=k4nd9r8qxx;data source=DBconjuntoid012.mssql.somee.com;persist security info=False;initial catalog=DBconjuntoid012");
            conexion.Open();
        }
        public void Cerrar()
        {
